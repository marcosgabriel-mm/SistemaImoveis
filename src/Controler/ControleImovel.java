...
public class ControleImovel {
    ...
    private void alteraEstadoPropostaPorTipoImovel(String tipoImovel, Imovel imo, Proposta pro, String novoEstado) {
        List<Imovel> listaImovelTipo;

        if (tipoImovel.equals(Util.CASA)) {
            listaImovelTipo = listaImovelCasa;
        } else if (tipoImovel.equals(Util.APTO)) {
            listaImovelTipo = listaImovelApto;
        } else if (tipoImovel.equals(Util.SALA)) {
            listaImovelTipo = listaImovelSala;
        } else if (tipoImovel.equals(Util.RURAL)) {
            listaImovelTipo = listaImovelRural;
        } else if (tipoImovel.equals(Util.LOTE)) {
            listaImovelTipo = listaImovelLote;
        } else {
            // Trate o caso em que o tipo de imóvel não é reconhecido
            return;
        }

        for (Imovel imov : listaImovelTipo) {
            if (imov == imo) {
    ...
    public void procuraAlteraEstadoProposta(Imovel imo, Proposta pro, String novoEstado) {
        ...
        alteraEstadoPropostaPorTipoImovel(tipoImo, imo, pro, novoEstado);
